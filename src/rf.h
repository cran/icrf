...
void survTree(double *x, double *prob, double *pIndexMat, double *peto,
             ...
             int method, int ert, int uniErt,
             int udNPMLE, double *lr, double *pf, double *intmap,
             double *timepoints, double *tau, double *bw, int fold, int debug);
...
void PETO(double* surv, double* lr, double *timepoints, int nsample, int ntime, double* stat,
          int type);
